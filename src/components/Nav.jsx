...
const Nav = () => {
  ...
  return (
    <>
      <header className='padding-x py-8 z-50 w-full top-0 fixed bg-slate-100'>
        <nav className='flex justify-between items-center max-w-screen-xl mx-auto'>
          <a href="/">
            <img src={"https://upload.wikimedia.org/wikipedia/commons/7/77/Olympia_sports.png"} alt="logo" className="w-32 h-auto" />
          </a>
