  ...
  return <>
    <section className="flex justify-between items-center max-lg:flex-col gap-10 w-full max-container" id="about-us">
      ...
      <div className="flex flex-1 flex-col">
        ...
        <p className='mt-4 lg:max-w-lg info-text'>Explore Olympia Sports's world of top-tier sportswear and athletic footwear. Uncover high-quality products meticulously crafted to elevate both your athletic performance and style. Shop the latest collections and indulge in unbeatable comfort and fashion. Join the Olympia Sports community today.
        </p>
        <p className='mt-6 lg:max-w-lg info-text'>
          Immerse yourself in our newest collections, delivering unparalleled comfort and unrivaled style. Become a part of the Olympia Sports community today and experience the pinnacle of sportswear excellence.
        </p>
